...
Route::match(['get', 'post'], '/woa/column', [\App\Http\Controllers\StaticController::class, 'notfound'])->name('column');
Route::match(['get', 'post'], '/woa/seminar', [\App\Http\Controllers\StaticController::class, 'notfound'])->name('seminar');
