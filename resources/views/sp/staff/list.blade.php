...
<body>
    ...
    <h1 class="p-seminar-head">ウィルワン スタッフ紹介</h1>
...
<main class="l-contents">
        <div class="l-contents-container">
            <div class="l-contents-main">
                ...
                <div class="c-button-wrap-color"><a href="{{ route('Glp', ['lpId' => config('ini.ENTRY_TEMPLATE_ID.sp.other')])}}?action=spor-stafflist-btn" class="c-button-big">
            ...
            @include('sp.mainparts.stafflistsidebar')
