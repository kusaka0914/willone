...
<head>
    ...
    <link href="/css/recruit/sp/feed.css?20201216" rel="stylesheet" media="all">
...
<body class="sp" ontouchstart="" onLoad="_ga('send','event','feedlp','click','{{$feed_id}}_{{$ab_pattern}}_open', 0, {nonInteraction: 1});">
    <header role="banner" class="feedLP_header_A">
        <input id="feedAbPattern" type="hidden" value='{{$feed_id}}_{{$ab_pattern}}'>
        <div class="row kja-l_head">
            <div class="large-24 columns">
                <div class="row align-middle text-center">
                    <div class="small-24 columns">
                        <img class='img_header_A' src="/woa/images/logo.png" alt="ウィルワンエージェント">
                    </div>
                    <!-- / .columns -->
                </div>
                <!-- / .row -->
