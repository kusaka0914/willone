...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ addQuery('/woa/entry/sp/form27/css/style.css') }}">
...
<body class="step1">
	<div class="contents">
		...
		<div class="modal branch">
          ...
          <div class="labelHeading">
					   <h2 class="itemTitle">お気持ちはどちらに近いですか？</h2>
          </div>
		...
		<form id="form" name="form1" action="@if (preg_match('/jinzaibank.com/', $_SERVER['HTTP_HOST'])){{ route('EntryFin')}}@else{{ route('EntryFinFromOld')}}@endif" method="post">
			...
			<div id="dialog_form" data-initialstate="false">
				<div id="dialog_header">
					<h1><img src="/woa/entry/sp/form27/img/head.png" alt="ウィルワン ハローワーク非掲載も多数！新着・会員限定のレア求人をご紹介！"></h1>
				...
				<div id="dialog_content">
					<ul class="bxslider">
						<li>
      					...
      					<div class="step"><img data-page-num="1" src="/woa/entry/sp/form27/img/status/1.png" width="250"></div>
                    ...
                    <li class="col @if(@in_array($value->id, $license)) checked @endif">
						...
						<li>
      					...
      					<div class="step"><img data-page-num="5"  src="/woa/entry/sp/form27/img/status/2.png" width="250"></div>
								<div id="req_date_area" class="formItem">
									...
									@foreach ($req_dateList as $value)
											...
											<label for="req_date_{{ $loop->iteration }}" class="radio">{{ $value->req_date }}</label>
											</li>
									@endforeach
									</ul>
                  ...
                  <li class="col @if (@in_array($value->id, $req_emp_type)) checked @endif">
                    <input type="radio" value="{{ $value->id }}" id="req_emp_type_{{ $loop->iteration }}" name="req_emp_type[]" @if (@in_array($value->id, $req_emp_type)) checked="checked" @endif disabled="disabled">
						...
						<li>
      					...
      					<div class="step"><img  data-page-num="3" src="/woa/entry/sp/form27/img/status/3.png" width="250"></div>
						...
						<li>
      					...
      					<div class="step"><img  data-page-num="4" src="/woa/entry/sp/form27/img/status/4.png" width="250"></div>
								<p class="smallTxt key"><small>公開されません</small></p>
						...
						<li>
      					...
      					<div class="step"><img data-page-num="5" src="/woa/entry/sp/form27/img/status/5.png" width="250"></div>
								<p class="smallTxt key"><small>公開されません</small></p>
								<div class="addTxt message" style="padding-top:0">
									<p>これでラストです！</p>
								</div>
								...
								<div id="retirement_intention_area">
									...
									<div class="formItem bottomItem">
										...
										@foreach ($retirement_intentionList as $key => $value)
											<li class="@if ($key === old('retirement_intention')) checked @endif">
	...
	<script src="/woa/entry/sp/form27/js/jq.bxslider_for_horizscrl_form.js?20221121"></script>
	<script src="/woa/entry/sp/form27/js/validation_form.js"></script>
	<script src="{{addQuery('/woa/entry/sp/form27/js/horizontal_scroll_form.js')}}"></script>
	<script src="/woa/entry/sp/form27/js/modal_footer.js"></script>
	<script src="/woa/entry/sp/form27/js/sp_modal_browserback.js?20221114"></script>
