...
<head>
	...
	<script type="text/javascript" src="{{addQuery('/woa/entry/sp/form2005/js/jq.bxslider_for_horizscrl_form.js')}}"></script>
	<script type="text/javascript" src="{{addQuery('/woa/entry/sp/form2005/js/validation_form.js')}}"></script>
	<script src="{{addQuery('/woa/entry/sp/form2005/js/horizontal_scroll_form.js')}}"></script>
	<link href="{{addQuery('/woa/entry/sp/form2005/css/style.css')}}" rel="stylesheet" type="text/css">
	...
	<div class="contents">
		...
		<div class="modal branch">
			<div class="modalBody intro">
				<div id="branch">
					<h1><span>まずは現在のお気持ちを教えてください。</span></h1>
...
@include('common._hidden_entry')
			<div id="dialog_form" data-initialstate="false">
				<div id="dialog_header">
					<h1><img src="/woa/entry/sp/form2005/img/head.png" alt="ウィルワン ハローワーク非掲載も多数！新着・会員限定のレア求人をご紹介！"></h1>
@include('common._error_message')
					<div class="status">
                        <img id="form_status" data-page-num="1" src="/woa/entry/sp/form2005/img/status/1.png">
                    </div>
				</div>
					...
					<ul class="bxslider">
						<li>
							<div id="Step1" style="visibility: visible;">
                                ...
                                @include('sp.contents.include._indeed')
									...
									@foreach($licenseList as $value)
										...
										<li class="col">
											...
											<label for="license_{{$value->id}}" class="checkbox">
												<img src="/woa/entry/sp/form2005/img/license_{{$value->id}}.png" width="45px">{{$value->license}}
											</label>
										</li>
										@endif
									@endforeach
										...
										<li class="col" id="slide_student_btn">
											<img src="/woa/entry/sp/form2005/img/license_student.png" width="45px">学生
										</li>
									</ul>
                            ...
                            @include('sp.contents.include._indeed')
								...
								<div id="req_emp_types_area" class="formItem">
									...
									@foreach ($reqEmpTypeList as $value)
										...
										<label for="req_emp_type_{{$loop->iteration}}" class="radio"><img src="/woa/entry/sp/form2005/img/req_emp_type_{{$value->id}}.png" width="45px">{!! nl2br($value->emp_type_br) !!}</label>
										</li>
									@endforeach
									</ul>
								...
								<div id="req_date_area" class="formItem">
									...
									@foreach ($req_dateList as $value)
											...
											<label for="req_date_{{$loop->iteration}}" class="radio"><img src="/woa/entry/sp/form2005/img/req_date_{{$value->id}}.png" width="45px">{{$value->req_date}}</label>
											</li>
									@endforeach
									</ul><!-- end formItem -->
							...
							<div id="Step3" style="visibility: visible;">
								...
								<div id="zip_area" class="formItem">
                                    ...
                                    <div class="addTxt message">
                                        <img src="/woa/entry/sp/form2005/img/ico_01-2.png" alt="ポイント">
						...
						<li>
							<div id="Step5" style="visibility: visible;">
                                ...
                                <div class="formItem formItem-terms">
                                    <p class="formItem-terms-text">応募エントリー前に利用規約をご確認ください。</p>
                                    <div class="terms">
                                        <input type="checkbox" id="terms_checkbox" name="terms_checkbox" value='1'>
                                        <div class="formItem-terms-agree">
                                            <a href="/woa/rule" target='_blank' rel="dialog">利用規約</a>
                                            <span>に同意する</span>
                                        </div>
                                    </div>
									<div class="error_message" id="terms_checkbox_errmsg"></div>
                                </div>
