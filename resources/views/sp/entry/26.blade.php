...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ addQuery('/woa/entry/sp/form26/css/style.css') }}">
...
<body class="step1">
		...
		<form id="form" name="form1" action="@if (preg_match('/jinzaibank.com/', $_SERVER['HTTP_HOST'])){{ route('EntryFin')}}@else{{ route('EntryFinFromOld')}}@endif" method="post">
			...
			<div id="dialog_form" data-initialstate="false">
				<div id="dialog_header">
					<h1><img src="/woa/entry/sp/form26/img/head.png" alt="ウィルワン ハローワーク非掲載も多数！新着・会員限定のレア求人をご紹介！"></h1>
				...
				<div id="dialog_content">
					<ul class="bxslider">
						<li>
      					...
      					<div class="step"><img data-page-num="1" src="/woa/entry/sp/form26/img/status/1.png" width="250"></div>
						...
						<li>
      					...
      					<div class="step"><img data-page-num="5"  src="/woa/entry/sp/form26/img/status/2.png" width="250"></div>
						...
						<li>
      					...
      					<div class="step"><img  data-page-num="3" src="/woa/entry/sp/form26/img/status/3.png" width="250"></div>
						...
						<li>
      					...
      					<div class="step"><img  data-page-num="4" src="/woa/entry/sp/form26/img/status/4.png" width="250"></div>
								<p class="smallTxt key"><small>公開されません</small></p>
						...
						<li>
      					...
      					<div class="step"><img data-page-num="5" src="/woa/entry/sp/form26/img/status/5.png" width="250"></div>
								<p class="smallTxt key"><small>公開されません</small></p>
	...
	<script src="/woa/entry/sp/form26/js/jq.bxslider_for_horizscrl_form.js?20221121"></script>
	<script src="/woa/entry/sp/form26/js/validation_form.js"></script>
	<script src="{{addQuery('/woa/entry/sp/form26/js/horizontal_scroll_form.js')}}"></script>
	<script src="/woa/entry/sp/form26/js/modal_footer.js"></script>
	<script src="/woa/entry/sp/form26/js/sp_modal_browserback.js?20221114"></script>
