...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ addQuery('/woa/entry/sp/form3008/css/style.css') }}">
...
<body class="step1">
		...
		<form id="form" name="form1" action="@if (preg_match('/jinzaibank.com/', $_SERVER['HTTP_HOST'])){{ route('EntryFin')}}@else{{ route('EntryFinFromOld')}}@endif" method="post">
			...
			<div id="dialog_form" data-initialstate="false">
				<div id="dialog_header">
					<h1><img src="/woa/entry/sp/form3008/img/logo.svg" alt="【国試黒本】柔道整復師・鍼灸師・マッサージ師試験の参考書/国家試験対策" height="12" width="65"></h1>
                  	...
                  	<p>残り&nbsp;<span>50%</span>&nbsp;！</p>&nbsp;カンタン60秒で求人検索！
								...
								<div id="zip_area">
                                    ...
                                    <div class="addTxt message">
                                        <img src="/woa/entry/sp/form3008/img/human.png" alt="ポイント">
	...
	<script src="/woa/entry/sp/form3008/js/jq.bxslider_for_horizscrl_form.js?20221121"></script>
	<script src="{{addQuery('/woa/js/common/ga4_common.js')}}"></script>
	<script src="{{ addQuery('/woa/entry/sp/form3008/js/validation_form.js') }}"></script>
	<script src="{{addQuery('/woa/entry/sp/form3008/js/horizontal_scroll_form.js')}}"></script>
	<script src="{{addQuery('/woa/entry/sp/form3008/js/sp_modal_browserback.js')}}"></script>
