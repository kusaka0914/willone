...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ addQuery('/woa/entry/sp/form3004/css/style.css') }}">
...
<body class="step1">
		...
		<form id="form" name="form1" action="@if (preg_match('/jinzaibank.com/', $_SERVER['HTTP_HOST'])){{ route('EntryFin')}}@else{{ route('EntryFinFromOld')}}@endif" method="post">
			...
			<div id="dialog_form" data-initialstate="false">
				<div id="dialog_header">
					<h1>
                        <img src="/woa/entry/sp/form3004/img/head.png" alt="ウィルワン ハローワーク非掲載も多数！新着・会員限定のレア求人をご紹介！">
								...
								<div id="license_area" class="formItem">
									...
									<ul id="license_container" class="colWrap">
                                        <div class="formItemStudent">
											...
											<li class="col @if (@in_array($value->id, $license) || in_array($value->license, $shikaku)) checked @endif">
												...
												<label for="license_{{ $value->id }}" class="checkbox">
													<img src="/woa/entry/sp/form3004/img/license_{{ $value->id }}.png" width="45px">{{ $value->license }}
												</label>
											</li>
											@endif
											@endforeach
                                        ...
                                        <li class="col slide-student-btn" id="slide_student_btn">
											就業中の方はこちら
											<img src="/woa/entry/sp/form3004/img/352466_arrow_down_icon.svg" width="45px">
										</li>
							...
							<div id="Step2" style="visibility: visible;">
								...
								<div id="req_emp_types_area" class="formItem">
									...
									@foreach ($reqEmpTypeList as $value)
										...
										<label for="req_emp_type_{{ $loop->iteration }}" class="radio"><img src="/woa/entry/sp/form3004/img/req_emp_type_{{ $value->id }}.png" width="45px">{!! nl2br($value->emp_type_br) !!}</label>
										</li>
									@endforeach
									</ul>
							...
							<div id="Step3" style="visibility: visible;">
								...
								<div id="zip_area">
                                    ...
                                    <div class="addTxt message">
                                        <img src="/woa/entry/sp/form3004/img/ico_01-2.png" alt="ポイント">
	...
	<script src="/woa/entry/sp/form3004/js/jq.bxslider_for_horizscrl_form.js?20221121"></script>
	<script src="{{addQuery('/woa/entry/sp/form3004/js/validation_form.js')}}"></script>
	<script src="{{addQuery('/woa/entry/sp/form3004/js/horizontal_scroll_form.js')}}"></script>
	<script src="/woa/entry/sp/form3004/js/sp_modal_browserback.js?20221114"></script>
