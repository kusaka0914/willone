...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ addQuery('/woa/entry/sp/form25/css/style.css') }}">
...
<body class="step1" style='overflow:hidden;'>
		...
		<form id="form" name="form1" action="@if (preg_match('/jinzaibank.com/', $_SERVER['HTTP_HOST'])){{ route('EntryFin')}}@else{{ route('EntryFinFromOld')}}@endif" method="post">
			...
			<div id="dialog_form" data-initialstate="false">
				<div id="dialog_header">
					<h1><img src="/woa/entry/sp/form25/img/head.png" alt="ウィルワン ハローワーク非掲載も多数！新着・会員限定のレア求人をご紹介！"></h1>
				...
				<div id="dialog_content">
					<ul class="bxslider">
                        ...
                        <a data-modal="branch" style="display: none;">お気持ちはどちらに近いですか？</a>
                            <div class="modalBody intro" style='height:280px;'>
                                <div id="branch">
								...
								<div id="license_area" class="formItem">
									...
									<ul id="license_container" class="colWrap">
                                        ...
                                        <li class="col slide-student-btn" id="slide_student_btn">
											学生の方はこちら
											<img src="/woa/entry/sp/form25/img/352466_arrow_down_icon.svg" width="45px">
										</li>
										<div class="formItemStudent" style="display: none;">
											@foreach ($licenseList as $value)
											@if (in_array($value->id, $licenseStudent))
											<li class="col license-student-item @if (@in_array($value->id, $license)) checked @endif">
							...
							<div id="Step2" style="visibility: visible;">
								<div id="req_date_area" class="formItem">
									...
									@foreach ($req_dateList as $value)
										<li class="col req-date-item @if ($value->id == old('req_date')) checked @endif">
								...
								<div id="req_emp_types_area" class="formItem">
									...
									@foreach ($reqEmpTypeList as $value)
										<li class="col req-emp-type-item @if (@in_array($value->id, $req_emp_type)) checked @endif">
							...
							<div id="Step3" style="visibility: visible;">
								...
								<div id="zip_area">
                                    ...
                                    <div class="addTxt message">
                                        <img src="/woa/entry/sp/form25/img/ico_01-2.png" alt="ポイント">
								...
								<div id="retirement_intention_area">
									...
									<div class="formItem bottomItem">
										...
										@foreach ($retirement_intentionList as $key => $value)
											<li class="retirement-intention-item @if (old('retirement_intention')==$key)) checked @endif">
	...
	<script src="/woa/entry/sp/form25/js/jq.bxslider_for_horizscrl_form.js?20221121"></script>
	<script src="/woa/entry/sp/form25/js/validation_form.js"></script>
	<script src="{{addQuery('/woa/entry/sp/form25/js/horizontal_scroll_form.js')}}"></script>
	<script src="/woa/entry/sp/form25/js/sp_modal_browserback.js?20221114"></script>
