...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ addQuery('/woa/entry/sp/form31/css/style31.css') }}">
...
<body class="step1">
		...
		<form id="form" name="form1" action="@if (preg_match('/jinzaibank.com/', $_SERVER['HTTP_HOST'])){{ route('EntryFin')}}@else{{ route('EntryFinFromOld')}}@endif" method="post">
			...
			<div id="dialog_form" data-initialstate="false">
				<div id="dialog_header">
					<h1><img src="/woa/entry/sp/form31/img/head01.png" alt="ウィルワン 『国試黒本』の運営会社だから提供できる！専門性の高い治療家の就職・転職サポート" class="header01"><img src="/woa/entry/sp/form31/img/head02.png" alt="ウィルワン ハローワーク非掲載も多数！新着・会員限定のレア求人をご紹介！" class="header02"></h1>
					...
					<ul class="bxslider">
									...
									<ul id="license_container" class="colWrap">
										...
										<li class="col">
											...
											<label for="license_{{ $value->id }}" class="checkbox">
												<img src="/woa/entry/sp/form31/img/license_{{ $value->id }}.png" width="45px">{{ $value->license }}
											</label>
										</li>
										@endif
										@endforeach
										...
										<li class="col" id="slide_student_btn">
											<img src="/woa/entry/sp/form31/img/license_student.png" width="45px">学生
										</li>
									</ul>
							...
							<div id="Step2" style="visibility: visible;">
								...
								<div id="req_date_area" class="formItem">
									...
									@foreach ($req_dateList as $value)
											...
											<label for="req_date_{{ $loop->iteration }}" class="radio"><img src="/woa/entry/sp/form31/img/req_date_{{ $value->id }}.png" width="45px">{{ $value->req_date }}</label>
											</li>
									@endforeach
									</ul>
								...
								<div id="req_emp_types_area" class="formItem">
									...
									@foreach ($reqEmpTypeList as $value)
										...
										<label for="req_emp_type_{{ $loop->iteration }}" class="radio"><img src="/woa/entry/sp/form31/img/req_emp_type_{{ $value->id }}.png" width="45px">{!! nl2br($value->emp_type_br) !!}</label>
										</li>
									@endforeach
									</ul>
							...
							<div id="Step4" style="visibility: visible;">
								...
								<div id="zip_area">
                                    ...
                                    <div class="addTxt message">
                                        <img src="/woa/entry/sp/form31/img/ico_01-2.png" alt="ポイント">
						...
						<li>
							<div id="Step5" style="visibility: visible;">
								...
								<h2 class="itemTitle icon mailico">メールアドレス</h2>
								<div class="formItem">
    ...
    <script src="{{addQuery('/woa/entry/sp/form31/js/jq.bxslider_for_horizscrl_form.js')}}"></script>
    <script src="{{addQuery('/woa/entry/sp/form31/js/validation_form.js')}}"></script>
	<script src="{{addQuery('/woa/entry/sp/form31/js/horizontal_scroll_form.js')}}"></script>
    <script src="{{addQuery('/woa/entry/sp/form31/js/modal_footer.js')}}"></script>
    <script src="{{addQuery('/woa/entry/sp/form31/js/sp_modal_browserback.js')}}"></script>
