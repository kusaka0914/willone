...
<head>
	...
	<script type="text/javascript" src="/woa/entry/sp/form2004/js/jq.bxslider_for_horizscrl_form.js"></script>
	<script type="text/javascript" src="/woa/entry/sp/form2004/js/validation_form.js"></script>
	<script type="text/javascript" src="/woa/entry/sp/form2004/js/horizontal_scroll_form.js"></script>
	<script type="text/javascript" src="/woa/entry/sp/form2004/js/modal_footer.js"></script>
	<link rel="stylesheet" type="text/css" href="/woa/entry/sp/form2004/css/style.css?20211020">
...
@include('common._hidden_entry')
			<div id="dialog_form" data-initialstate="false">
				<div id="dialog_header">
					<h1><img src="/woa/entry/sp/form2004/img/head.png" alt="ウィルワン ハローワーク非掲載も多数！新着・会員限定のレア求人をご紹介！"></h1>
@include('common._error_message')
					<div class="status"><img id="form_status" data-page-num="1" src="/woa/entry/sp/form2004/img/status/1.png"></div>
				</div>
									...
									@foreach($licenseList as $value)
										...
										<li class="col @if(@in_array($value->id, $license)) checked @endif">
											...
											<label for="license_{{$value->id}}" class="checkbox">
												<img src="/woa/entry/sp/form2004/img/license_{{$value->id}}.png" width="45px">{{$value->license}}
											</label>
										</li>
										@endif
									@endforeach
										...
										<li class="col" id="slide_student_btn">
											<img src="/woa/entry/sp/form2004/img/license_student.png" width="45px">学生
										</li>
									</ul>
							...
							<div id="Step2" style="visibility: visible;">
								<div id="req_emp_types_area" class="formItem">
									...
									@foreach ($reqEmpTypeList as $value)
										...
										<label for="req_emp_type_{{$loop->iteration}}" class="radio"><img src="/woa/entry/sp/form2004/img/req_emp_type_{{$value->id}}.png" width="45px">{!! nl2br($value->emp_type_br) !!}</label>
										</li>
									@endforeach
									</ul>
								...
								<div id="req_date_area" class="formItem">
									...
									@foreach ($req_dateList as $value)
											...
											<label for="req_date_{{$loop->iteration}}" class="radio"><img src="/woa/entry/sp/form2004/img/req_date_{{$value->id}}.png" width="45px">{{$value->req_date}}</label>
											</li>
									@endforeach
									</ul><!-- end formItem -->
						...
						<li>
							<div id="Step4" style="visibility: visible;">
								...
								<div class="addTxt message" style="padding-top:0">
									<img src="/woa/entry/sp/form2004/img/ico_01-2.png" alt="ポイント">
