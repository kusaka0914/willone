...
<head>
	...
	<script type="text/javascript" src="/woa/entry/sp/form2000/js/jq.bxslider_for_horizscrl_form.js"></script>
	<script type="text/javascript" src="/woa/entry/sp/form2000/js/validation_form.js"></script>
	<script type="text/javascript" src="/woa/entry/sp/form2000/js/horizontal_scroll_form.js"></script>
	<script type="text/javascript" src="/woa/entry/sp/form2000/js/modal_footer.js"></script>
	<link rel="stylesheet" type="text/css" href="/woa/entry/sp/form2000/css/style.css?20210108">
					...
					<ul class="bxslider">
						<li>
							<div id="Step1" style="visibility: visible;">
								<div id="license_area">
									...
									<h2>
										<strong style="font-size: 1.7em; line-height: 1.3; color: #ff6b6b;"> {{ $office_name }} </strong>
										<b style="display: inline-block;">について問い合わせる</b>
									</h2>
									@else
									<h2>どの資格でお探しですか？</h2>
									@endif
									<ul class="formItem">
										...
										<li class="col @if(@in_array($value->id, $license)) checked @endif">
											...
											<label for="license_{{$value->id}}" class="checkbox">
												<img src="/woa/entry/sp/form08/img/license_{{$value->id}}.png" width="45px">{{$value->license}}
											</label>
										</li>
										@endif
										@endforeach
										...
										<li class="col" id="slide_student_btn">
											<img src="/woa/entry/sp/form08/img/license_student.png" width="45px">学生
										</li>
									</ul>
							...
							<div id="Step2" style="visibility: visible;">
								<div id="req_emp_types_area">
									...
									@foreach ($reqEmpTypeList as $value)
										...
										<label for="req_emp_type_{{$loop->iteration}}" class="radio"><img src="/woa/entry/sp/form08/img/req_emp_type_{{$value->id}}.png" width="45px">{!! nl2br($value->emp_type_br) !!}</label>
										</li>
									@endforeach
									</ul><!-- end formItem -->
								...
								<div id="req_date_area">
									...
									@foreach ($req_dateList as $value)
											...
											<label for="req_date_{{$loop->iteration}}" class="radio"><img src="/woa/entry/sp/form08/img/req_date_{{$value->id}}.png" width="45px">{{$value->req_date}}</label>
											</li>
									@endforeach
									</ul><!-- end formItem -->
						...
						<li>
							<div id="Step3" style="visibility: visible;">
								<div id="zip_area">
									<div class="formItem">
									<p class="addTxt">お住まいを中心に、お近くの求人情報をお届けいたします</p>
									<img src="/woa/entry/sp/form08/img/img_map.png" class="map">
									<h3>お住まいの<br>郵便番号</h3>
