                ...
                <div class="l-contents-main">
                    <div class="p-license-select">
                        ...
                        <div class="p-license-select-nav">
                            <div class="p-license-select-item active" data-license="judoseifukushi">柔整師</div>
                            <div class="p-license-select-item" data-license="ammamassajishiatsushi">あん摩師</div>
                        ...
                        <a href="/woa/interview-fti-1">
                            <div class="instructor-img-container">
                                <div class="instructor-img-container-left">
                                    ...
                                    <p class="instructor-img-container-left-subtitle">として働く<br>
                                        治療家インタビュー</p>
                    ...
                    @include('sp.mainparts.entrybutton', ['_action' => 'pcor-top-btn_bottom', 'lpId' => config('ini.ENTRY_TEMPLATE_ID.pc.top')])
                </div>
