...
<head>
    ...
    <!--og-->
    @include('common._ogp')
    <link rel="shortcut icon" href="/woa/favicon.ico" type="image/ico">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/woa/css/font-awesome.min.css">
    <!--css-->
    <link rel="stylesheet" href="{{ addQuery('/woa/css/style_sp.css') }}">
    <link href="/woa/css/styleapply.css?20180701" rel="stylesheet" media="all">
