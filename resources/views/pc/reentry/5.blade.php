...
<body id="pagetop" class="likeModal bg-completionPage pc style-mamiya reclamation reclamation-third theme-beige">
    <div class="header">
    ...
    <div class="likeModal_contents ani-showFloaty">
        <div id="wrap">
            <!-- 3秒転職アンケート -->
            <div class="formMuscle formMuscle-reentry">
                <div class="header-img">
                    <img src="/woa/images/concierge_header_pc.png" class="" alt="ウィルワンは国試黒本の運営会社が提供する治療家業専門の就職/就活支援サービスです。">
                </div>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide swiper-no-swiping">
                                        ...
                                        <div class="formMuscle_formItem" style="padding:0 4px;">
                                            ...
                                            @endif
                                            <div class="datetime-item">
                                                <input id="mob_phone" name="mob_phone" type="tel" value="{{$mob_phone ?? old('mob_phone')}}" style="ime-mode: disabled;" size="14" maxlength="11" @if (!empty($mob_phone)) class="placeOn on" @endif>
