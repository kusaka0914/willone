...
<body id="pagetop" class="likeModal bg-completionPage pc style-mamiya reclamation reclamation-third">
    <div class="header">
        ...
        <div id="wrap">
            ...
            <div class="formMuscle formMuscle-reentry">
                <div class="header-img">
                    <img src="/woa/images/header_banner_pc.png" class="" alt="willoneは国試黒本の運営会社が提供する治療家業専門の転職エージェントです">
                </div>
