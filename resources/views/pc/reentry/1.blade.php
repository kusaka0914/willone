...
<link rel="stylesheet" type="text/css" href="/woa/css/common/reentry.css?20211216">
...
@endforeach
     ...
     <div class="formMuscle_formItem" style="padding:0 4px;">
      <button type="button" id="submitMob" class="formMuscle_submit disabled" name="submitMob" onclick="setBtnAction('job_detail'); submitOnce();">求人情報を問い合わせる</button>
     </div>
    </div><!-- /.swiper-slide -->
  </div><!-- /.swiper-wrapper -->
