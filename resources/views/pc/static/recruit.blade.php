    ...
    <main class="l-contents">
        <div class="l-contents-container">
            <div class="l-contents-main">
				...
				<div><img src="/woa/images/recruit1.jpg"></div>
				<div class="u-text-c"><img src="/woa/images/recruit2.jpg"></div>
				<div class="c-button-wrap u-mb40"><a href="#formlink" class="c-button">
                    <i class="fa fa-caret-right"></i> ウィルワンに人材紹介を申し込む
                </a></div>

				<div><img src="/woa/images/recruit3.jpg"></div>

				<div class="p-recruit-main u-mb20">
					<div><img src="/woa/images/recruit_image1.jpg"></div>
					<p class="u-p15 u-mt0">
				...
				<div class="p-recruit-main u-mb20">
					<div><img src="/woa/images/recruit_image2.jpg"></div>
					<p class="u-p15 u-mt0">
				...
				<div class="p-recruit-main">
					<div><img src="/woa/images/recruit_image3.jpg"></div>
					<p class="u-p15 u-mt0">
				...
				<div class="c-button-wrap u-mb40 u-mt0"><a href="#formlink" class="c-button">
                    <i class="fa fa-caret-right"></i> ウィルワンに人材紹介を申し込む
                </a></div>
