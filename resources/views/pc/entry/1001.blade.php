...
<head>
    ...
    <script type="text/javascript" src="/woa/js/entry/pc/form1001/jq.bxslider_for_horizscrl_form1.js?20191220"></script>
    <script type="text/javascript" src="/woa/js/entry/pc/form1001/validation_form1.js?20200720"></script>
    <script src="{{addQuery('/woa/js/entry/pc/form1001/horizontal_scroll_form1.js')}}"></script>
    <script src="{{addQuery('/woa/js/common/enterBlock.js')}}"></script>
    <link href="{{addQuery('/woa/css/entry/pc/style1001.css')}}" rel="stylesheet" type="text/css">
...
@endif
                        ...
                        <div class="formItem">
                            ...
                            <div class="error_message errorBox02" id="introduce_name_errmsg" @if($errors->has('introduce_name')) style="display: block;" @endif>{{ $errors->first('introduce_name') }}</div>
                        </div>
                    </div>
                </li>{{-- /STEP1 --}}
