...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ addQuery('/woa/entry/pc/form20/css/style.css') }}">
	<link rel="stylesheet" href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">
	@include ('common._gtag')
	<link rel="icon" href="/woa/favicon.ico">
</head>
<body class="step1" style='overflow:hidden;'>
	<div class="contents">
        <div class="hands" style="right: calc(48% - 160px); top: 25%;z-index:1000000"></div>
		...
		<form id="form" name="form1" action="@if (preg_match('/jinzaibank.com/', $_SERVER['HTTP_HOST'])){{ route('EntryFin')}}@else{{ route('EntryFinFromOld')}}@endif" method="post">
			...
			<div id="dialog_form" data-initialstate="false">
				<div id="dialog_header">
					<h1><img src="/woa/entry/pc/form20/img/head.png" alt="ウィルワン ハローワーク非掲載も多数！新着・会員限定のレア求人をご紹介！"></h1>
				...
				<div id="dialog_content">
					<ul class="bxslider">
                        ...
                        <a data-modal="branch" style="display: none;">お気持ちはどちらに近いですか？</a>
                            <div class="modalBody intro" style='height:320px;'>
                                <div id="branch">
									...
									<ul id="license_container" class="colWrap">
										...
										<li class="col @if(@in_array($value->id, $license)) checked @endif">
											...
											<label for="license_{{ $value->id }}" class="checkbox">
												<img src="/woa/entry/pc/form20/img/license_{{ $value->id }}.png" width="45px">{{ $value->license }}
											</label>
										</li>
										@endif
										@endforeach
										...
										<li class="col" id="slide_student_btn">
											<img src="/woa/entry/pc/form20/img/license_student.png" width="45px">学生
                  	...
                  	<p>残り&nbsp;<span>70%</span>&nbsp;！</p>&nbsp;カンタン60秒で求人検索！
								...
								<div id="req_date_area" class="formItem">
									...
									@foreach ($req_dateList as $value)
											...
											<input type="radio" value="{{ $value->id }}" id="req_date_{{ $loop->iteration }}" name="req_date" @if ($value->id == $req_date) checked="checked" @endif disabled="disabled">
											<label for="req_date_{{ $loop->iteration }}" class="radio"><img src="/woa/entry/pc/form20/img/req_date_{{ $value->id }}.png" width="45px">{{ $value->req_date }}</label>
											</li>
									@endforeach
									</ul>
								...
								<div id="req_emp_types_area" class="formItem">
									...
									@foreach ($reqEmpTypeList as $value)
										...
										<label for="req_emp_type_{{ $loop->iteration }}" class="radio"><img src="/woa/entry/pc/form20/img/req_emp_type_{{ $value->id }}.png" width="45px">{!! nl2br($value->emp_type_br) !!}</label>
										</li>
									@endforeach
									</ul>
                  	...
                  	<p>残り&nbsp;<span>50%</span>&nbsp;！</p>&nbsp;カンタン60秒で求人検索！
								...
								<div id="zip_area">
									...
									<div class="formItem">
										...
										<input type="number" value="{{ old('zip') }}" name="zip" id="zip" style="ime-mode: disabled;" class="width150zip" disabled="disabled" maxlength="7" inputmode="numeric"/>
                                    ...
                                    <div class="addTxt message">
                                        <img src="/woa/entry/pc/form20/img/ico_01-2.png" alt="ポイント">
                  ...
                  <div class="stepbar__text">
                  	<p>残り&nbsp;<span>30%</span>&nbsp;！</p>&nbsp;カンタン60秒で求人検索！
								...
								<div class="formItem formItem_step4 name_cana-frame">
                  ...
                  <div class="stepbar__text">
                  	<p>これでラストです！</p>
								...
								<div class="formItem">
									<input id="mob_phone" name="mob_phone" type="tel" value="{{ old('mob_phone')}}" style="ime-mode: disabled;" size="14" disabled="disabled" maxlength="11">
	...
	<script src="/woa/js/common/ga_common.js?20221206"></script>
	...
	<script src="/woa/entry/pc/form20/js/jq.bxslider_for_horizscrl_form.js"></script>
	<script src="/woa/entry/pc/form20/js/validation_form.js"></script>
	<script src="{{addQuery('/woa/entry/pc/form20/js/horizontal_scroll_form.js')}}"></script>
	<script src="/woa/entry/pc/form20/js/pc_modal_browserback.js?20221114"></script>
