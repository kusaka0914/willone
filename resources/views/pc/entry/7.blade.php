...
<head>
    ...
    <script type="text/javascript" src="{{addQuery('/woa/js/entry/pc/form7/jq.bxslider_for_horizscrl_form.js')}}"></script>
    <script type="text/javascript" src="{{addQuery('/woa/js/entry/pc/form7/validation_form.js')}}"></script>
    <script type="text/javascript" src="{{addQuery('/woa/js/entry/pc/form7/horizontal_scroll_form.js')}}"></script>
    <script src="{{addQuery('/woa/js/entry/pc/form7/pc_modal_browserback.js')}}"></script>
    <script src="{{addQuery('/woa/js/common/enterBlock.js')}}"></script>
    <link href="{{addQuery('/woa/css/entry/pc/style7.css')}}" rel="stylesheet" type="text/css">
...
@include('common._error_message')
        <form id="form" name="form7" action="@if (preg_match('/jinzaibank.com/', $_SERVER['HTTP_HOST'])){{ route('EntryFin')}}@else{{ route('EntryFinFromOld')}}@endif" method="post">
          ...
          <div id="dialog_form" class="formContent" data-initialstate="false">
            <div id="dialog_header" class="formHeader">
              <div class="row rowTable">
                <div class="col last"><img id="form_status" data-page-num="1" src="/woa/entry/img/status/1.png"></div>
              </div>
            </div>
                        ...
                        <div class="formItem formItem-terms">
                            ...
                            <div class="terms">
                                ...
                                <div class="formItem-terms-agree">
                                    <a href="/woa/rule" rel="dialog" target="_blank">利用規約</a>
                                    <span>に同意する</span>
                                </div>
                            </div>
                            <div class="error_message errorBox02 err_pos03" id="terms_checkbox_errmsg"></div>
                        </div>
