...
<head>
    ...
    <script type="text/javascript" src="/woa/js/entry/pc/form3000/jq.bxslider_for_horizscrl_form2.js?20211207"></script>
    <script src="{{ addQuery('/woa/js/entry/pc/form3000/validation_form2.js') }}"></script>
    <script src="{{ addQuery('/woa/js/entry/pc/form3000/horizontal_scroll_form2.js') }}"></script>
    <script src="{{addQuery('/woa/js/entry/pc/form3000/pc_modal_browserback.js')}}"></script>
    <script src="{{addQuery('/woa/js/common/enterBlock.js')}}"></script>
    <link href="{{addQuery('/woa/css/entry/pc/style3000.css')}}" rel="stylesheet" type="text/css">
...
<body class="step1">
    <div class="header">
        <img src="/woa/images/logo_kurohon.svg" class="header-logo" alt="国試黒本">
    </div>
    <div class="contents">
    <div class="form">
