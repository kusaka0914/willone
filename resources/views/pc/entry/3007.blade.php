...
<head>
    ...
    <script type="text/javascript" src="/woa/entry/pc/form3007/js/jq.bxslider_for_horizscrl_form2.js?20211207"></script>
    <script src="{{ addQuery('/woa/entry/pc/form3007/js/validation_form2.js') }}"></script>
    <script src="{{ addQuery('/woa/entry/pc/form3007/js/horizontal_scroll_form2.js') }}"></script>
    <script src="{{addQuery('/woa/entry/pc/form3007/js/pc_modal_browserback.js')}}"></script>
    <script src="{{addQuery('/woa/js/common/enterBlock.js')}}"></script>
    <link href="{{addQuery('/woa/entry/pc/form3007/css/style.css')}}" rel="stylesheet" type="text/css">
...
<div class="wrapper">
    <div class="main">
    <div class="header">
        <img src="/woa/entry/pc/form3007/img/logo.svg" class="header-logo" alt="国試黒本">
    </div>
          ...
          <div id="dialog_form" class="formContent" data-initialstate="false">
            <div id="dialog_header" class="formHeader">
              <div class="row rowTable">
                <div class="col last"><img id="form_status" data-page-num="1" src="/woa/entry/pc/form3007/img/1.png"></div>
              </div>
            </div>
