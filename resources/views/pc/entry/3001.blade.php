...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ addQuery('/woa/entry/pc/form3001/css/style.css') }}">
...
<body class="step1">
		...
		<form id="form" name="form1" action="@if (preg_match('/jinzaibank.com/', $_SERVER['HTTP_HOST'])){{ route('EntryFin')}}@else{{ route('EntryFinFromOld')}}@endif" method="post">
			...
			<div id="dialog_form" data-initialstate="false">
				<div id="dialog_header">
					<h1>
                        <img src="/woa/entry/pc/form3001/img/head.png" alt="ウィルワン ハローワーク非掲載も多数！新着・会員限定のレア求人をご紹介！">
                        <p>就職やキャリアに関するお悩みなどなんでもご相談ください！</p>
                    </h1>

                    <div class="header-img-wrap">
                        <img src="/woa/entry/sp/form3001/img/header-img.png" alt="ウィルワンが治療家学生の就職を完全無料でサポート!">
					...
					<ul class="bxslider">
							...
							<div id="Step1" class="step1-2" style="visibility: visible;">
								<div id="license_area" class="formItem">
									...
									<ul id="license_container" class="colWrap">
										<div class="formItemStudent">
											...
											<li class="col @if (in_array($value->id, $license) || in_array($value->license, $shikaku)) checked @endif">
												...
												<label for="license_{{ $value->id }}" class="checkbox">
													<img src="/woa/entry/pc/form3001/img/license_{{ $value->id }}.png" width="45px">{{ $value->license }}
												</label>
											</li>
											@endif
											@endforeach
                                        ...
                                        就業中の方はこちら
											<img src="/woa/entry/pc/form3001/img/arrow_down_icon.svg" width="45px">
										</li>
							...
							<div id="Step2" style="visibility: visible;">
								...
								<div id="req_emp_types_area" class="formItem">
									...
									@foreach ($reqEmpTypeList as $value)
										...
										<label for="req_emp_type_{{ $loop->iteration }}" class="radio"><img src="/woa/entry/pc/form3001/img/req_emp_type_{{ $value->id }}.png" width="45px">{!! nl2br($value->emp_type_br) !!}</label>
										</li>
									@endforeach
									</ul>
							...
							<div id="Step3" style="visibility: visible;">
								...
								<div id="zip_area">
									...
									<div class="formItem">
										...
										<input type="number" value="{{$zip ?? old('zip') }}" name="zip" id="zip" style="ime-mode: disabled;" class="width150zip @if (!empty($zip)) placeOn on @endif" disabled="disabled" maxlength="7" inputmode="numeric"/>
                                    ...
                                    <div class="addTxt message">
                                        <img src="/woa/entry/pc/form3001/img/ico_01-2.png" alt="ポイント">
						...
						<li>
							<div id="Step4" style="visibility: visible;">
								...
								<input type="text" size="20" name="name_cana" id="name_cana" value="{{ old('name_cana')}}" placeholder="例：せいたいはなこ" @empty($name_kan) disabled="disabled" @endempty maxlength="64">
								</div>
						...
						<li>
							<div id="Step5" style="visibility: visible;">
								...
								<div class="formItem">
									<input id="mob_phone" name="mob_phone" type="tel" value="{{$mob_phone ?? old('mob_phone')}}" style="ime-mode: disabled;" size="14" disabled="disabled" maxlength="11" @if (!empty($mob_phone)) class="placeOn on" @endif>
	...
	<script src="/woa/entry/pc/form3001/js/jq.bxslider_for_horizscrl_form.js"></script>
	<script src="{{addQuery('/woa/entry/pc/form3001/js/validation_form.js')}}"></script>
	<script src="{{addQuery('/woa/entry/pc/form3001/js/horizontal_scroll_form.js')}}"></script>
	<script src="/woa/entry/pc/form3001/js/pc_modal_browserback.js?20221114"></script>
