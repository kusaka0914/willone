...
<head>
    ...
    <script type="text/javascript" src="/woa/js/entry/pc/form6/jq.bxslider_for_horizscrl_form.js?20211207"></script>
    <script type="text/javascript" src="/woa/js/entry/pc/form6/validation_form.js?20211207"></script>
    <script type="text/javascript" src="{{addQuery('/woa/js/entry/pc/form6/horizontal_scroll_form.js')}}"></script>
    <script src="{{addQuery('/woa/js/entry/pc/form6/pc_modal_browserback.js')}}"></script>
    <script src="{{addQuery('/woa/js/common/enterBlock.js')}}"></script>
    <link href="{{addQuery('/woa/css/entry/pc/style6.css')}}" rel="stylesheet" type="text/css">
          ...
          <div id="dialog_form" class="formContent" data-initialstate="false">
            <div id="dialog_header" class="formHeader">
              <div class="row rowTable">
                <div class="last"><img id="form_status" data-page-num="1" src="/woa/entry/img/status/1.png"></div>
              </div>
            </div>
