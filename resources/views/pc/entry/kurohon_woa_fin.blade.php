...
<body class="step1 kurohon-form">
    ...
    <div class="dialog-header">
        ...
        <p class="dialog-header-text">治療家領域における就職/転職は私たちにお任せください</p>
        @include ("common._shortholiday")
    </div>
    <div class="mgn-b40">
        <div class="dialog-box dialog-box-kurohon-logo">
            <div class="kurohon-logo">
                <img src="https://kurohon.jp/wp-content/themes/kurohon/assets/images/logo.svg" alt="">
                <img src="https://kurohon.jp/wp-content/themes/kurohon/assets/images/logo-text.svg" alt="">
            </div>
            <a href="{{ config('ini.KUROHON_MYPAGE') }}" class="dialog-box-btn dialog-kurohon-btn">
            国試黒本に戻る
