<h2 class="c-title-l"><i class="fa fa-search"></i>職種から探す</h2>
                <ul class="c-type">
                    <li class="c-type-item">
                        <a href="{{ route('JobAreaSelect' , ['id' => 'judoseifukushi' , 'pref' => $pref_roma ])}}" class="c-type-link">
                            <div class="c-type-img" style="background-image:url(/woa/images/search_type_icon1.png)"></div>
                            <span class="c-type-text">柔道整復師</span>
                        </a>
                    </li>
                    <li class="c-type-item">
                        <a href="{{ route('JobAreaSelect' , ['id' => 'ammamassajishiatsushi' , 'pref' => $pref_roma])}}" class="c-type-link">
                    ...
                    <li class="c-type-item">
                        <a href="{{ route('JobAreaSelect' , ['id' => 'harikyushi' , 'pref' => $pref_roma])}}" class="c-type-link">
                            <div class="c-type-img" style="background-image:url(/woa/images/search_type_icon3.png)"></div>
                            <span class="c-type-text">鍼灸師</span>
                        </a>
                    </li>
                    <li class="c-type-item">
                        <a href="{{ route('JobAreaSelect' , ['id' => 'seitaishi_therapist' , 'pref' => $pref_roma])}}" class="c-type-link">
