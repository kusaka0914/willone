...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/woa/css/entry/pc/style1.css?20180108">
...
<body id="pagetop" class="likeModal bg-completionPage pc style-mamiya">
  <div class="header">
  ...
  <div class="likeModal_contents ani-showFloaty">
    <div id="wrap">
      ...
      <div class="formMuscle">
        <div class="formMuscle_box stepLicense pc" style="padding-top: 1em; margin-bottom: 200px;">
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide swiper-no-swiping">
                    ...
                    <div id="license_container" class="formMuscle_formItem formItemLicense" style="padding:0 4px;">
                      <div class="formMuscle_error" id="errorMsg_license" style="display: none; margin-top: 5px;">お持ちの資格を下記から選んでください！</div>
                      <div class="formMuscle_error" id="graduation_year_errmsg" style="display: none; margin-top: 5px;">学生の場合は卒業年を下記から選んでください！</div>
                        ...
                        <div id="license_container" class="formItem">
                          <div class="row row3col">
                            ...
                            <div class="col @if(@in_array($value->id, old('license', []))) checked @endif">
                              ...
                              <label for="license_{{$value->id}}" class="checkbox"><span>{{$value->license}}</span></label>
                            </div>
                            @endforeach
                          </div>
                        </div>
                        <div id="graduation_year_area" style="display:@if($student) block; @else none; @endif;">卒業年：
                    ...
                    <div class="formMuscle_formItem" style="padding:0 4px;">
                      <button type="button" id="button-next1" class="formMuscle_submit disabled">次へ <i class="fa fa-chevron-right" style="margin: 0 -0.5em 0 0.5em;"></i></button>
                    </div><!-- /.formMuscle_formItem -->
                  </div><!-- /.swiper-slide -->
                  ...
                  <div class="swiper-slide swiper-no-swiping">
                    ...
                    <div class="formMuscle_formItem" style="padding:0 4px;">
                      <div class="formMuscle_error" id="errorMsg_req_emp_type_recent" style="display: none; margin-top: 5px;">ご希望の雇用形態を下記から選んでください！</div>
                  ...
                  <div class="swiper-slide swiper-no-swiping">
                    ...
                    <div class="formMuscle_formItem" style="padding:0 4px;">
                      <div class="formMuscle_error" id="errorMsg_req_date_recent" style="display: none; margin-top: 5px;">ご希望の転職希望時期を下記から選んでください！</div>
                  ...
                  <div class="swiper-slide swiper-no-swiping">
                    <div class="formMuscle_formItem" style="padding:0 4px;">
                      <h2 class="formMuscle_title" style="margin: 0 auto 5px; color: #0dc582; text-align: center;"><strong>退職のご意向</strong>を教えてください！</h2>
                      <div class="formMuscle_error" id="errorMsg_req_retirement_recent" style="display: none; margin-top: 5px;">退職のご意向を下記から選んでください！</div>
                    ...
                    <div class="formMuscle_formItem" style="padding:0 4px;">
                      <h2 class="formMuscle_title" style="margin: 0 auto 5px; color: #0dc582; text-align: center;"><strong>電話番号</strong>を入力してください！</h2>
                      ...
                      <ul>
                        <li>
                          <input type="text" name="tel" id="tel" value="{{ old('tel')}}" size="14" placeholder="例：09012345678" maxlength="11">
...
<script type="text/javascript" src="/woa/js/entry/pc/form1/modal_footer1.js?20181019"></script>
...
$.dispGradYear = function() {
  ...
  $("#button-next2").on('click', function() {
    if ($.validate(3)) {
      ...
      $(".formMuscle_box").addClass('stepRetirementIntention');
      $('html,body').scrollTop(0);
      return true;
    }
    return false;
  ...
  $("input[name='req_retirement_recent[]']").change(function() {
    if ($.validate(4) && $.checkValidate('tel') == '') {
