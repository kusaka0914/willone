...
$(function() {
  ...
  $("#slide_student_btn").on("click", function() {
    ...
    $(".bxslider > li").height("");
    $('.bx-viewport').css('min-height', 590);
    $(".hands").hide();
    ...
    switch (pagenum) {
      case 1:
        ...
        if($('#slide_student_btn').is(':visible')){
          $('.bx-viewport').css('min-height', 380);
        } else {
          $('.bx-viewport').css('min-height', 590);
        }
      ...
      case 2:
        ...
        $("#retirement_intention_area").hide();
        $(".terms-link").hide();
        $('.bx-viewport').css('min-height', 475);
        break;
      case 3:
        $("body")
        ...
        $("#retirement_intention_area").hide();
        $(".terms-link").hide();
        $('.bx-viewport').css('min-height', 465);
      ...
      case 5:
        ...
        $('.bx-viewport').css('min-height', 550);
        break;
    }
