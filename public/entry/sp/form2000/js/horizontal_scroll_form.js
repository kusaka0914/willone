...
$(function() {
  ...
  //
  $(".lastupdate").after(
    '<div class="pMark"><p><a href="http://privacymark.jp/" target="_blank" onclick="$.sendGA(1, \'privacymark\');"><img src="/woa/img/pmark/100x100.gif" alt="プライバシーマーク" class="mar_rm"></a><b>安心してご登録いただくために</b><br>ナース専科 転職を運営する(株)エス・エム・エスはプライバシーマークを取得しております。</p></div>'
  );
  ...
  $('input[name="req_date"]').on("change", function() {
    var result = $.validate_item("req_date");
