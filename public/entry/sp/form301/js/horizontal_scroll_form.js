...
$(function () {
  ...
  slider = $(".bxslider").bxSlider({
    ...
    onSlideBefore: $.onSlideBeforeHandler
  });
  ...
  $(".step1 .bx-viewport").height(step1height);
  ...
  $('.formItemStudent .col').on('click', function(){
    $(".bx-viewport").height("720");
  })
...
$.onSlideBeforeHandler = function ($slideElement, oldIndex, newIndex) {
  var pagenum = newIndex + 1;
  pageNo = pagenum;

  if(pageNo == 1){
    if ($('#slide_student_btn').css('display') === 'none') {
      $(".bxslider").height(700);
    } else {
        $(".bxslider").height(500);
    }
  ...
  switch (pagenum) {
    case 1:
      if (Object.keys(result.errors).length == 0) {
        ...
        setTimeout(function () {
          $('html, body').animate({ scrollTop: $(window).scrollTop() - 10 }, 100);
        }, 100);
    ...
    case 3:
      if (Object.keys(result.errors).length == 0) {
        ...
        setTimeout(function () {
          $('html, body').animate({ scrollTop: $(window).scrollTop() + 30 }, 100);
        }, 300);
    ...
    case 4:
      if (Object.keys(result.errors).length == 0) {
        ...
        $(".hands").animate({ top: position.top + 250 }, 0);
