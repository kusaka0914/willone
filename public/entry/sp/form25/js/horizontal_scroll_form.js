...
$(function () {
  ...
  $("a.bx-next").html('<span class="nextBtn">次へ</span>');
  ...
  $('input[name="license[]"]').on("change", function () {
    ...
    const licenseItemCnt = $('.license-item.checked').length;
    if(licenseItemCnt == 0){
      $('.license-item').removeClass('unChecked');
    }

    $('.license-student-item').each(function(){
      if($(this).hasClass('checked')){
        $(this).removeClass('unChecked');
      } else {
        $(this).addClass('unChecked');
    ...
    const licenseStudentItemCnt = $('.license-student-item.checked').length;
    if(licenseStudentItemCnt == 0){
      $('.license-student-item').removeClass('unChecked');
    }
  ...
  $('input[name="req_emp_type[]"]').on("change", function () {
    ...
    $('.req-emp-type-item').each(function(){
      if($(this).hasClass('checked')){
        $(this).removeClass('unChecked');
      } else {
        $(this).addClass('unChecked');
  ...
  $('input[name="retirement_intention"]').on("change", function () {
    ...
    $('.retirement-intention-item').each(function(){
      if($(this).hasClass('checked')){
        $(this).removeClass('unChecked');
      } else {
        $(this).addClass('unChecked');
