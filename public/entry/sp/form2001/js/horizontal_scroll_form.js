...
$.onSlideAfterHandler = function($slideElement, oldIndex, newIndex) {
  ...
  if (pagenum < 6) {
    ...
    if (pagenum < 5) {
      ...
      $("a.bx-next").html(
        '<span class="lastBtn"><small>利用規約に同意の上</small><br>理想の職場を探しに行く!</span>'
      );
    }
  ...
  if (pagenum == 5) {
    ...
    $(".bx-controls-direction").after(
      '<div class="terms-link"><a href="/woa/rule" rel="dialog nofollow" id="kiyaku" data-modal="rule" data-transition="pop">利用規約</a></div>'
    );
  }
};
